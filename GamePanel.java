...
public class GamePanel extends JPanel implements ActionListener{
    ...
    public void draw(Graphics g) {
        if (running) {
            ...
            g.drawString("APPLE EATEN: "+AppleAte, (SCREEN_WIDTH-metrics.stringWidth("APPLE EATEN: "+AppleAte))/2, g.getFont().getSize());
        }
        else{
            gameOver(g);
        }
    ...
    public void gameOver(Graphics g) {
        ...
        g.drawString("SCORE: "+AppleAte, (SCREEN_HEIGHT-metrics1.stringWidth("SCORE: "+AppleAte))/2, g.getFont().getSize());
        //Game Over
        g.setColor(Color.RED);
        ...
        g.drawString("Try Again", (SCREEN_WIDTH-metrics3.stringWidth("Try Again"))/2, SCREEN_HEIGHT/3);
